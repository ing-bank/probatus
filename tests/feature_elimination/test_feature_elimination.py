...
@pytest.mark.skipif(os.environ.get("SKIP_LIGHTGBM") == "true", reason="LightGBM tests disabled")
def test_shap_rfe_early_stopping(complex_data, complex_lightgbm, capsys):
    """
...
@pytest.mark.skipif(os.environ.get("SKIP_LIGHTGBM") == "true", reason="LightGBM tests disabled")
def test_shap_rfe_randomized_search_early_stopping(complex_data, complex_lightgbm, capsys):
    """
...
@pytest.mark.skipif(os.environ.get("SKIP_LIGHTGBM") == "true", reason="LightGBM tests disabled")
def test_get_feature_shap_values_per_fold_early_stopping(complex_data, complex_lightgbm):
    """
    Test with ShapRFECV with features per fold.
    """
    clf = complex_lightgbm
