...
def make_tree_mock():
    ...
    return mock_tree(
        ...
        thresh=np.array([-3.54, -2.0, 2.795, -1.985, -2.0, -2.0, -2.0]),
    )
...
def make_complex_tree_mock():
    ...
    return mock_tree(
        ...
        thresh=np.array([-3.54, -2, 2.795, -1.985, -2.785, -2.0, -2.0, 1.675, -2.0, -2.0, 3.925, 3.865, -2.0, -2.0, -2.0]),
    )
